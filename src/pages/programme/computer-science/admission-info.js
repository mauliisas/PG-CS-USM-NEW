  ...
  return (
    <>
      <Layout isContent={true} titleContent={"Admission Info"}>
        <Head>
          <title>Computer Science | Admission Info</title>
        </Head>
        <section className='min-h-main py-12'>
          <article className='layout h3 font-medium text-justify space-y-4'>
            <div className='space-y-2'>
              ...
              <ul className='list-disc ml-10'>
                ...
                <li>
                  <p>a) CGPA of 2.5 - 2.74/4.00 with</p>
                  <ul className='list-disc ml-10'>
                    <li>
                  ...
                  <p>b) CGPA of 2.00 - 2.49/4.00 with</p>
                  <ul className='list-disc ml-10'>
                    <li>
          ...
          <div className='space-y-2'>
            ...
            <p>Full-time: Min 2 semesters / Max 4 semesters</p>
          </div>
